...
class RobotJointConfig:
    ...
    canonical_joints: List[Optional[str]] = field(default_factory=list)
    ...
    # --- Termination ---
    base_link: str = "torso"
    orientation_limit: Optional[float] = None  # radians; None = no orientation termination
...
ROBOT_CONFIGS: Dict[str, RobotJointConfig] = {
    ...
    "digit": RobotJointConfig(
        canonical_joints=[
            ...
            None, None, None,
            # 15-19: Left Arm
            "left_arm_shoulder_pitch", "left_arm_shoulder_roll", "left_arm_shoulder_yaw", "left_arm_elbow", None,
            # 20-24: Right Arm
            "right_arm_shoulder_pitch", "right_arm_shoulder_roll", "right_arm_shoulder_yaw", "right_arm_elbow", None,
        ],
        kinematic_type="bird",
    ...
    "h1": RobotJointConfig(
        canonical_joints=[
            # 0-11: Legs
            "left_hip_pitch", "left_hip_roll", "left_hip_yaw", "left_knee", "left_ankle", None,
            "right_hip_pitch", "right_hip_roll", "right_hip_yaw", "right_knee", "right_ankle", None,
            # 12-14: Torso
            "torso", None, None,
            # 15-19: Left Arm
            "left_shoulder_pitch", "left_shoulder_roll", "left_shoulder_yaw", "left_elbow", None,
            # 20-24: Right Arm
            "right_shoulder_pitch", "right_shoulder_roll", "right_shoulder_yaw", "right_elbow", None,
        ],
        kinematic_type="humanoid",
        base_link="torso_link",
        orientation_limit=None,
